...
kernel: cmain.o boot.o lib/libc.a irq_asm.o irq.o gdt.o pit.o paging.o keyboard.o pci.o pcnet32.o  print_info.o memory.o net.o ether.o arp.o ipv4.o ld.script
